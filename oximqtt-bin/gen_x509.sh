...
# server ca
SERVER_KEY_FILE="oximqtt.key"
SERVER_CERT_FILE="oximqtt.pem"
SERVER_CERT_FULL_CHAIN_FILE="oximqtt.fullchain.pem"
SERVER_CERT_DAYS=3650
SERVER_REQ_FILE="oximqtt.req"
