...
**oximqtt-test** is the industrial-grade test harness, chaos engineering, and benchmarking engine for the [OXIMQTT](https://github.com/zeaphoo/oximqtt) MQTT broker.
...
- **Broker Lifecycle Management** — Auto start/stop/restart `oximqttd` process with TCP health checks
...
The program will auto-locate `target/release/oximqttd` and start the broker.
