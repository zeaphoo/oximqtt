...
//!
//! Provides centralized node monitoring and resource management, implementing:
...
/// Represents a single OXIMQTT broker node.
///
...
impl Node {
    ...
    pub fn version() -> String {
        format!("oximqtt/{VERSION}-{RUSTC_BUILD_TIME}")
    }
