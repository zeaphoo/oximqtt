...
/// ```
/// use oximqtt::utils::{Counter, StatsMergeMode};
///
...
impl Counter {
    ...
    /// # Example
    /// ```
    /// let c = oximqtt::utils::Counter::new();
    /// ```
    #[inline]
    pub fn new() -> Self {
    ...
    /// # Example
    /// ```
    /// let c = oximqtt::utils::Counter::new_with(5, 10, oximqtt::utils::StatsMergeMode::Sum);
    /// ```
    #[inline]
    ...
    /// # Example
    /// ```
    /// let a = oximqtt::utils::Counter::new_with(3, 10, oximqtt::utils::StatsMergeMode::None);
    /// let b = oximqtt::utils::Counter::new_with(2, 5, oximqtt::utils::StatsMergeMode::None);
    /// a.add(&b);
    /// ```
    #[inline]
    ...
    /// # Example
    /// ```
    /// let a = oximqtt::utils::Counter::new();
    /// let b = oximqtt::utils::Counter::new_with(5, 100, oximqtt::utils::StatsMergeMode::None);
    /// a.set(&b);
    /// ```
    #[inline]
    ...
    /// # Example
    /// ```
    /// let a = oximqtt::utils::Counter::new_with(1, 2, oximqtt::utils::StatsMergeMode::Sum);
    /// let b = oximqtt::utils::Counter::new_with(3, 4, oximqtt::utils::StatsMergeMode::Sum);
    /// a.merge(&b);
    /// ```
    #[inline]
