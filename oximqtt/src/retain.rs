...
//!    - `DefaultRetainStorage`: Production-ready in-memory implementation
//!
//! ## Design Highlights
...
/// functional but logs a warning recommending the `oximqtt-retainer`
...
/// Production deployments should use the `oximqtt-retainer` plugin
...
impl RetainStorage for DefaultRetainStorage {
    ...
    async fn set(
        ...
        log::warn!("Please use the \"oximqtt-retainer\" plugin as the main program no longer supports retain messages.");
        Ok(())
    }
