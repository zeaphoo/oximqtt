...
/// # Example
/// ```
/// use oximqtt::acl::{Rule, Permission, Action, Topic};
/// use oximqtt::types::{ConnectInfo, Id, QoS};
/// let rule = Rule {
...
/// # Example
/// ```
/// let perm = oximqtt::acl::Permission::try_from("allow").unwrap();
/// ```
...
/// # Example
/// ```
/// let action = oximqtt::acl::Action::try_from("publish").unwrap();
/// ```
...
/// # Example
/// ```
/// use oximqtt::types::{ConnectInfo, Id};
/// use oximqtt::acl::Topic;
