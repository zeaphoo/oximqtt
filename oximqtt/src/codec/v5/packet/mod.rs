...
pub use crate::codec::types::{ConnectAckFlags, ConnectFlags, QoS};

use super::{encode::*, property_type as pt, UserProperties};
use crate::codec::error::{DecodeError, EncodeError};
use crate::codec::types::packet_type;
use crate::codec::utils::{take_properties, write_variable_length, Decode, Property};
...
mod ack_props {
    use super::*;
    use crate::codec::v5::UserProperty;
