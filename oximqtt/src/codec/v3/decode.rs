...
use crate::codec::types::{packet_type, Protocol, QoS, MQISDP, MQTT, MQTT_LEVEL_31, MQTT_LEVEL_311, WILL_QOS_SHIFT};
use crate::codec::utils::Decode;
...
mod tests {
    use super::*;
    use crate::codec::utils::decode_variable_length;
    use crate::codec::v3::ConnectAckReason;
