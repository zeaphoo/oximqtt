...
use crate::codec::types::{packet_type, ConnectFlags, QoS, MQTT_LEVEL_311, WILL_QOS_SHIFT};
use crate::codec::utils::{write_variable_length, Encode};
...
#[cfg(test)]
mod tests {
    use crate::codec::types::Protocol;
    use bytes::Bytes;
