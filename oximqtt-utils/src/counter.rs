...
/// ```
/// use oximqtt_utils::{Counter, StatsMergeMode};
///
...
impl Counter {
    ...
    /// # Example
    /// ```
    /// let c = oximqtt_utils::Counter::new();
    /// ```
    #[inline]
    pub fn new() -> Self {
    ...
    /// # Example
    /// ```
    /// let c = oximqtt_utils::Counter::new_with(5, 10, oximqtt_utils::StatsMergeMode::Sum);
    /// ```
    #[inline]
    ...
    /// # Example
    /// ```
    /// let a = oximqtt_utils::Counter::new_with(3, 10, oximqtt_utils::StatsMergeMode::None);
    /// let b = oximqtt_utils::Counter::new_with(2, 5, oximqtt_utils::StatsMergeMode::None);
    /// a.add(&b);
    /// ```
    #[inline]
    ...
    /// # Example
    /// ```
    /// let a = oximqtt_utils::Counter::new();
    /// let b = oximqtt_utils::Counter::new_with(5, 100, oximqtt_utils::StatsMergeMode::None);
    /// a.set(&b);
    /// ```
    #[inline]
    ...
    /// # Example
    /// ```
    /// let a = oximqtt_utils::Counter::new_with(1, 2, oximqtt_utils::StatsMergeMode::Sum);
    /// let b = oximqtt_utils::Counter::new_with(3, 4, oximqtt_utils::StatsMergeMode::Sum);
    /// a.merge(&b);
    /// ```
    #[inline]
