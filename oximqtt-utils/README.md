...
[![crates.io page](https://img.shields.io/crates/v/oximqtt-utils.svg)](https://crates.io/crates/oximqtt-utils)
[![docs.rs page](https://docs.rs/oximqtt-utils/badge.svg)](https://docs.rs/oximqtt-utils/latest/oximqtt_utils)

Common utilities for the OXIMQTT MQTT broker: byte sizes, durations, timestamps, node addresses, env var expansion, and atomic counters.
...
via `Arc<CircuitBreaker>`. Used by the builtin retainer module to avoid
blocking the broker when a storage backend is unreachable.
