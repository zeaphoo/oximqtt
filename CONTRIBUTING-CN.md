...
感谢你考虑为 OXIMQTT 贡献代码！本文档概述了开发工作流、代码规范和流程。
...
4. **注明环境信息** — 操作系统、Rust 版本（`rustc --version`）、OXIMQTT 版本
...
OXIMQTT 通过了 [paho.mqtt.testing](https://github.com/eclipse/paho.mqtt.testing) 测试套件：
