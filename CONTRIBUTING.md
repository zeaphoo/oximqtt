...
# Contributing to OXIMQTT

Thank you for considering contributing to OXIMQTT! This guide outlines the development workflow, code standards, and processes we follow.
...
4. **Specify your environment** — OS, Rust version (`rustc --version`), OXIMQTT version
...
**Scopes** (examples): `core`, `net`, `codec`, `conf`, `test`, `builtins/acl`, `cli`
...
2. **Integration tests** — `oximqtt-test` harness with five suite types:
...
OXIMQTT passes the [paho.mqtt.testing](https://github.com/eclipse/paho.mqtt.testing) test suite:
